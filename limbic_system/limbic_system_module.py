...
class LimbicSystem:
    ...
    def __init__(
        ...
        *,
        ...
        context_size: int = 10,
        memory_router: Optional[FactRouter] = None,
        ...
        self.memory_router = memory_router or (FactRouter() if isinstance(FactRouter, type) else None)
    ...
    def _route_to_memory(self, signal: dict, evaluation: dict) -> None:
        ...
        try:
            self.memory_router.route_fact(record, category="emotion")
        except Exception:
            pass
