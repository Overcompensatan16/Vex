...
from external_loaders.factbook_handler import scrape_factbook
...
HANDLER_MAP = {
    "wikipedia": lambda info: wiki_download_and_clean("enwiki", ["Earth", "Moon"], domain="culture"),
    "arxiv": lambda info: fetch_subject("physics"),
    "factbook": lambda info: scrape_factbook(),
}
