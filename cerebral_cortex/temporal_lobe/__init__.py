...
class TemporalLobe:
    ...
    def process(self, auditory_fact):
        ...
        elif isinstance(auditory_fact, dict):
        ...
        if text:
            ...
            if isinstance(auditory_fact, dict):
                tag = auditory_fact.get("modality", tag)
                source = auditory_fact.get("source", source)
            else:
                tag = getattr(auditory_fact, "modality", tag)
                source = getattr(auditory_fact, "source", source)
